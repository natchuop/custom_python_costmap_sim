...
def parser():
    ...
    p.add_argument("--recon-steps",type=int,default=500); p.add_argument("--attack-steps",type=int,default=1200); p.add_argument("--recovery-steps",type=int,default=800); p.add_argument("--max-steps",type=int)
